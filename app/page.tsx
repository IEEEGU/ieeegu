...
// Loading component
const ComponentSkeleton = ({ height = "h-[200px]" }: { height?: string }) => (
  <div className={`animate-pulse bg-gray-200 rounded-lg w-full flex items-center justify-center ${height}`}>
...
export default function HomePage() {
    return (
        <div className="min-h-screen bg-white text-gray-900">
            ...
            {/* Lazy loaded sections with minimal gaps */}
            <div className="space-y-0">
                <Suspense fallback={<ComponentSkeleton height="h-[400px]" />}>
                    <Intro />
                </Suspense>

                <Suspense fallback={<ComponentSkeleton height="h-[300px]" />}>
                ...
                <Suspense fallback={<ComponentSkeleton height="h-[600px]" />}>
                    <WorldMapDemo />
                </Suspense>
            </div>
        </div>
