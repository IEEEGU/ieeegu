...
const upcomingEvents: Event[] = [
  {
    id: "upcoming-cs-climate-2025",
    title: "IEEE CS Climate and Sustainability Symposium",
    date: "November 3, 2025",
    description: "Join us for an engaging symposium focused on climate change and sustainability in technology. Explore how computing and engineering can contribute to environmental solutions, sustainable development, and green technologies. Features expert speakers, panel discussions, and interactive workshops on climate tech innovations.",
    category: "Symposium",
    location: "Galgotias University",
    status: 'upcoming',
    organizer: "IEEE Computer Society",
    duration: "1 Day",
    type: "Climate & Sustainability Symposium"
  },
  {
    id: "upcoming-cs-syp-techx-2025",
    title: "IEEE CS SYP TechX 2025",
    date: "November 29, 2025",
    description: "The premier technical excellence event by IEEE Computer Society Student and Young Professionals! Experience three days of cutting-edge technology showcases, hackathons, technical competitions, workshops, and networking opportunities. Connect with industry leaders, participate in innovation challenges, and explore the latest trends in computer science and technology.",
    category: "Tech Conference",
    location: "Galgotias University",
    status: 'upcoming',
    organizer: "IEEE CS SYP",
    duration: "3 Days",
    type: "Technical Excellence Event"
  }
];

const pastEvents: Event[] = [
  // --- migrated from upcomingEvents (marked as past) ---
  {
    id: "upcoming-1",
