...
const upcomingConferences: Conference[] = [
  {
    id: 'iccca-2025',
    title: 'ICCCA 2025',
    subtitle: 'International Conference on Computing and AI',
    date: 'November 28-30, 2025',
    location: 'Galgotias University',
    description: 'Explore the latest advancements in computing and artificial intelligence through this comprehensive virtual conference.',
    image: 'https://via.placeholder.com/400x250/1e40af/ffffff?text=ICCAI+2025',
    registrationUrl: '#',
    deadline: 'May 15, 2025',
    status: 'upcoming',
    topics: ['Machine Learning', 'Deep Learning', 'Computer Vision', 'Natural Language Processing'],
    keyFeatures: ['Virtual presentations', 'Live Q&A sessions', 'Digital networking', 'Online workshops']
  },
