...
export default function BlogLayout({ 
  ...
  return (
    <div className="bg-white pt-10 transition-colors duration-200 min-h-screen pb-16">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="flex justify-between items-center mb-8">
          <div>
            <Link href="/blog" className="text-3xl md:text-4xl font-bold text-blue-600 hover:underline">
              IEEE GU Blog
            </Link>
